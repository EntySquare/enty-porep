...
fn create_layer_labels(
    ...
    debug!("lookahead: {},num_producers:{},producer_stride:{}", lookahead, num_producers, producer_stride);
    const BYTES_PER_NODE: usize = (NODE_SIZE * DEGREE) + SHA_BLOCK_SIZE;
    debug!("BYTES_PER_NODE: {},NODE_SIZE:{},DEGREE:{},SHA_BLOCK_SIZE:{}", BYTES_PER_NODE, NODE_SIZE, DEGREE, SHA_BLOCK_SIZE);
...
pub fn create_labels_for_encoding<Tree: 'static + MerkleTreeTrait, T: AsRef<[u8]>>(
    ...
    debug!("sector_size:{},node_count:{} ,cache_window_nodes:{},default_cache_size:{},DEGREE:{},NODE_SIZE:{}", sector_size, node_count, cache_window_nodes, default_cache_size, DEGREE, NODE_SIZE);
